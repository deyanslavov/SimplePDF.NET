...
{
    internal HexadecimalStringObject(byte[] contentBytes) 
        : base(contentBytes)
    {
    ...
    {
        return $"{Constants.HexStringObjectPrefix}{Convert.ToHexString(_contentBytes)}{Constants.HexStringObjectPostfix}";
    }
}
